...
export type VehicleShape =
  'hatchback' | 'sedan' | 'suv' | 'muv' | 'van' | 'pickup' | 'coupe' | 'convertible';
...
export const VEHICLES: Record<VehicleShape, VehicleArt> = {
  hatchback: {
    profile:
      'M48 84 L46 58 Q46 50 52 44 L62 34 Q66 30 74 30 L126 30 Q134 30 140 36 L156 50 L186 55 Q194 57 196 64 L196 84',
    windows: [
      'M60 50 L68 38 Q70 35 75 35 L98 35 L98 50 Z',
      'M103 35 L124 35 Q130 35 134 39 L146 50 L103 50 Z',
    ],
    wheels: [76, 168],
  ...
  sedan: {
    profile:
      'M28 84 L28 62 Q28 56 36 55 L70 52 L88 36 Q93 32 100 32 L144 32 Q151 32 156 37 L172 52 L204 56 Q212 58 213 66 L213 84',
    windows: [
      'M90 50 L100 39 Q102 37 106 37 L124 37 L124 50 Z',
      'M129 37 L143 37 Q148 37 152 41 L161 50 L129 50 Z',
    ],
    wheels: [62, 182],
  ...
  suv: {
    profile:
      'M36 84 L36 44 Q36 30 50 28 L148 27 Q156 27 162 33 L176 48 L204 52 Q212 54 213 62 L213 84',
    windows: [
      'M48 48 L50 36 Q51 33 56 33 L96 33 L96 48 Z',
      'M101 33 L145 33 Q150 33 154 37 L164 48 L101 48 Z',
    ],
    wheels: [72, 180],
    lines: ['M98 50 L98 74'],
  },
  muv: {
    profile:
      'M24 84 L24 42 Q24 30 38 29 L146 28 Q154 28 160 34 L180 50 L206 54 Q214 56 215 64 L215 84',
    windows: [
      'M36 47 L38 35 Q39 33 43 33 L78 33 L78 47 Z',
      'M83 33 L118 33 L118 47 L83 47 Z',
      'M123 33 L143 33 Q148 33 152 37 L163 47 L123 47 Z',
    ],
    wheels: [58, 186],
  ...
  van: {
    ...
    windows: [
      'M44 44 L44 28 L110 28 L110 44 Z',
      'M116 28 L158 28 Q163 28 166 32 L181 46 L116 46 Z',
    ],
    wheels: [64, 178],
  ...
  pickup: {
    profile:
      'M20 84 L20 54 L96 54 L98 38 Q100 31 108 31 L146 31 Q153 31 158 36 L172 50 L204 54 Q212 56 213 64 L213 84',
  ...
  coupe: {
    profile:
      'M30 84 L30 64 Q30 58 38 57 L80 54 L102 40 Q108 36 116 36 L140 36 Q148 36 154 42 L172 55 L206 59 Q213 61 214 68 L214 84',
  ...
  convertible: {
    profile:
      'M30 84 L30 64 Q30 58 38 57 L120 56 L132 44 L136 44 L148 57 L206 59 Q213 61 214 68 L214 84',
