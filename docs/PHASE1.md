...
| Free places      | The first `FREE_MEMBERS_PER_COLLECTIVE` (5) people ever to join a collective, creator included, join free; places never refill                                                                                                                                                                                                                                                                                                                                                                                      | User rule. Free members get a ₹0 pass with the normal 60-day validity and no Payment row. Claimed under a row lock on the collective.                                                 |
| Joining          | Creating a Buying Post joins the collective for its item + city at once (starting it if needed), taking a free place if one is open; otherwise the Buying Pass payment follows straight away. Until a membership is ACTIVE a user can't see other buyers, open profiles, send or accept connection requests, or send direct messages (`JOIN_COLLECTIVE_FIRST`); only the buyer count is open                                                                                                                        | User request: join at creation, pay at the post, nothing before joining.                                                                                                              |
