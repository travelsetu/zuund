...
| Location         | GeoNames countries + cities of 15k+ people (~32k cities); GeoLite2 IP lookup pre-selects country and city                                                                                                                                                                                                                                                                                                                                                                                                           | User asked for all countries and IP-based suggestions. The IP guess is only pre-selected; the user confirms. IPs never leave the server.                                              |
