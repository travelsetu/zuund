...
| Match score      | Elite only: 0–100 per buyer with its reasons, from timeline (40), how sure they are (30) and distance band (30); holidays also weigh travel dates, hotel and nights (`buying-intents/match.ts`). `GET /buyers/matches` gives the best first for the Insights screen                                                                                                                                                                                                                                                                                                          | User decision 2026-09-24, overriding the spec's "a count, never a match score" for Elite; kept explainable, no budget until we collect one.                                           |
