/** Small stroke icon set (24px grid) so the web matches the app without an icon dependency. */
const PATHS = {
  ...
  pin: 'M12 21s-7-6.3-7-11.5A7 7 0 0 1 19 9.5C19 14.7 12 21 12 21zM12 12a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5',
